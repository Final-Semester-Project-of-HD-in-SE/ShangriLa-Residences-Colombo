...
// Retrieve total balance for the current month and username
...
// Balance that needs to be covered
$requiredBalance = 763;
$remainingBalance = $requiredBalance - ($totalBalance ?: 0);

$shouldDisplayNotification = $remainingBalance > 0; // Display notification if remaining balance is positive

// Determine if the Proceed to Payment button should be disabled
