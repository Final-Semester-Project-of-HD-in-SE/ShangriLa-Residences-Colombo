...
function displaycart() {
    ...
    document.getElementById('cartItem').innerHTML = cartItems || "Your cart is empty";
...
document.querySelector('form').addEventListener('submit', function (e) {
    ...
    const queryString = `items=${encodeURIComponent(JSON.stringify(cart))}&total=${encodeURIComponent(total.toFixed(2))}`;
